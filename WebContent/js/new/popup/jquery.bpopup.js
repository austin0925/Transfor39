/**
 * 20120321, Grandy: 增加 iframeScroll 來對 iframe 的 scroll 來做控制
 */
/******************************************************************************************************************
 * @name: bPopup
 * @type: jQuery
...
;(function($) {
    $.fn.bPopup = function(options, callback) {
            ...
            $selector.fadeOut(o.fadeSpeed, function() {
                if (o.loadUrl != null) {
                	try{
                		...
                		var msg = '這是開發時才會發生的錯誤, 如看到此訊息, 請將畫面剪貼, 寄給 Grandy\n\n';
                		msg += ( 'error:' + JSON.stringify( err ) + '\n\n' );
                		msg += ( 'contentContainer:' +  o.contentContainer );
                	}
                }
            });
            unbindEvents();
        ...
        function createContent() {
            ...
            switch (o.content) {
                case ('iframe'):
                    $('<iframe scrolling="' + o.iframeScroll + '" frameborder="0"></iframe>').attr('src', o.loadUrl).appendTo(o.contentContainer);	//Grandy, modify
                    break;
                default:
    ...
    $.fn.bPopup.defaults = {
        ...
        scrollBar: true,
        zIndex: 9999,
        iframeScroll: 'no'	//<==Grandy, 增加當 content 為 iframe 時, 可以使用這個選項來控制 iframe 的 scroll
    };
})(jQuery);